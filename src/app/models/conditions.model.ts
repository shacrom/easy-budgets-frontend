...
const GENERAL_CONDITIONS: Condition[] = [
  {
    ...
    texto: 'El plazo estimado de entrega es de [indicar días/semanas] desde la aceptación del presupuesto. Este plazo podrá verse modificado por causas ajenas a nuestra empresa o por cambios solicitados por el cliente.'
  },
  {
    id: '2',
    titulo: 'Garantías',
    texto: 'Todos los trabajos realizados están garantizados por un periodo de 2 años desde la fecha de finalización, cubriendo defectos de materiales y mano de obra. La garantía no cubre daños producidos por un uso inadecuado o falta de mantenimiento.'
  },
  {
    id: '3',
    titulo: 'Condiciones generales',
    texto: 'Los materiales empleados serán de primera calidad y cumplirán con todas las normativas vigentes. Cualquier modificación sobre el proyecto original será presupuestada aparte y deberá ser aprobada por el cliente antes de su ejecución. Al finalizar los trabajos, se procederá a la limpieza de la zona de obras.'
  },
  {
    id: '4',
  ...
  },
  {
    id: '5',
    titulo: '',
    texto: 'La venta de la mercancía descrita queda condicionada al total pago del importe estipulado en el plazo fijado, reservándose en todo caso Entrecuines Dos S.L el dominio de la citada mercancía hasta el total pago del importe contratado.'
  }
];
...
const DIOMO_CONDITIONS: Condition[] = [
  {
    id: '1',
    titulo: 'Condiciones específicas Diomo',
    texto: 'Este presupuesto incluye productos de la gama DIOMO, reconocidos por su excelencia en diseño y funcionalidad. Los materiales están sujetos a disponibilidad en el catálogo actual DIOMO.'
  },
  {
    id: '2',
    titulo: 'Plazo de fabricación y entrega',
    texto: 'DIOMO fabrica bajo pedido con un plazo estimado de 6-8 semanas desde la confirmación del proyecto. Este plazo puede variar según la complejidad del diseño y personalización solicitada.'
  },
  {
    id: '3',
    titulo: 'Diseño y personalización',
    texto: 'Se incluye un proyecto personalizado con renders 3D. Cualquier modificación en el diseño debe ser aprobada antes de iniciar la fabricación. Los cambios posteriores pueden implicar costes adicionales.'
  },
  {
    id: '4',
    titulo: 'Instalación profesional',
    texto: 'La instalación será realizada por técnicos especializados y certificados por DIOMO, garantizando el montaje según estándares de calidad del fabricante. Incluye ajuste y nivelación de todos los elementos.'
  },
  {
    id: '5',
    titulo: 'Garantía Diomo',
    texto: 'Garantía del fabricante DIOMO de 3 años para mobiliario y herrajes, y 5 años para electrodomésticos integrados. La garantía de instalación es de 2 años. Se requiere registro del producto para activar la garantía.'
  },
  {
    id: '6',
    titulo: 'Condiciones de pago',
    texto: '50% de señal a la firma del contrato y aprobación del diseño, 30% antes de inicio de fabricación, y 20% a la finalización de la instalación. Los pagos deben realizarse según calendario establecido.'
  },
  {
    id: '7',
    titulo: 'Acabados y materiales',
    texto: 'Los acabados y materiales se seleccionarán del catálogo DIOMO vigente. Se recomienda verificar muestras físicas antes de la confirmación definitiva, ya que los colores pueden variar según pantalla.'
  },
  {
    id: '8',
    titulo: '',
